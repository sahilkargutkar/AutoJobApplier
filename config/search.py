...
search_terms = ["Senior Software Engineer", "Senior Software Developer", "ReactJS Developer", "Front End Developer", "Full Stack Developer", "Web Developer", "Nodejs Developer"]
...
salary = "15000"                        # "$40,000+", "$60,000+", "$80,000+", "$100,000+", "$120,000+", "$140,000+", "$160,000+", "$180,000+", "$200,000+"
...
location = ["United Arab Emirates"]                      # (dynamic multiple select)
