...
### Code Guidelines
  ...
  New feature example
  ```python
  ##> ------ Sahil VIjay Kargutkar : godsscion - Feature ------
  ...
  ##> ------ Sahil VIjay Kargutkar : sahilkargutkar.sk@gmail.com - Bug fix ------
...
Copyright (C) 2024 Sahil VIjay Kargutkar  <sahilkargutkar.sk@gmail.com>
...
- **GitHub**
    ...
    - [Feature requests or Ideas](/discussions/categories/feature-requests-or-ideas)
    - [Polls](/discussions/categories/polls)
    - [Community Flex](/discussions/categories/community-flex)
    - [Support Q&A](/discussions/categories/support-q-a)
